...
export default function StudentExamPage() {
  ...
  if (isLoading) {
    return <div className="flex justify-center items-center h-screen"><Loader2 className="animate-spin text-blue-500" size={50}/></div>;
  }

  // نمایش ارور (مثلاً کاربر دوره را نخریده است)
  if (errorMsg) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] p-4 animate-in fade-in">
